package P2; /******************************************************************************
 *  Compilation:  javac P1.In.java
 *  Execution:    java P1.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
    ...
    ///// begin: section (1 of 2) of code duplicated from P1.In to StdIn.
    ...
    //// end: section (1 of 2) of code duplicated from P1.In to StdIn.
    ...
    ////  begin: section (2 of 2) of code duplicated from P1.In to StdIn,
    ...
    public char readChar() {
        ...
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)P1.In.readChar() error!"
    ...
    ///// end: section (2 of 2) of code duplicated from P1.In to StdIn */
     ...
     * @deprecated Replaced by {@code new P1.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new P1.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new P1.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
    ...
    /**
     * Unit tests the {@code P1.In} data type.
     *
