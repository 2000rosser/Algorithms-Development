...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    ***************************************************************************/
    ...
    private class HeapIterator implements Iterator<Key> {
        // create a new pq
        private helper_code.MinPQ<Key> copy;

        // add all items to copy of heap
        // takes linear time since already in heap order so no keys move
        public HeapIterator() {
            if (comparator == null) copy = new helper_code.MinPQ<Key>(size());
            else                    copy = new helper_code.MinPQ<Key>(size(), comparator);
            for (int i = 1; i <= n; i++)
                copy.insert(pq[i]);
        }
    ...
    public static void main(String[] args) {
        helper_code.MinPQ<String> pq = new helper_code.MinPQ<String>();
        while (!StdIn.isEmpty()) {
